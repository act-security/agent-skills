...
Verified against `iam-expand` 0.11.85, `iam-shrink` 0.1.91, `iam-convert` 0.1.89, `iam-truth` 0.1.17. Trigger eval: 10/10 should-fire queries fired in every run, 0/9 should-stay fired (38 runs). Output eval: 10/10 cases pass with the skill set installed.
